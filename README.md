# Splunk EventGen 7x for Amazon Connect SplunkBase App
This repo installs `eventgen` v7x on your Splunk Instance and then creates data for the Amazon Connect App.  
